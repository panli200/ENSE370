...
public class WheelGame {
    ...
    public static void main(String[] args) {
        ...
        String ans = answer.toUpperCase();//Covert the string to the upper case    
        char[] chars = ans.toCharArray();//Convert the string to the character array
        ...
        while(  guess.length()!= 4 ||
                char0 =='A' || char0 =='E' || char0 =='I'|| char0 =='O' || char0 =='U' ||
        ...
        /*If the guess times all correct the player is win, othervise vice versa*/    
        if(guessNum == guessRight){
            System.out.println("Congradulation! Game Over!");
            System.exit(0);
        }
        else    
